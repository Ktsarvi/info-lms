...
create policy "Users can insert their own payments" on payments for
insert with check (auth.uid () = user_id);
drop policy if exists "Users can update their own payments" on payments;
create policy "Users can update their own payments" on payments for
...
grant select,
  insert,
  update on public.payments to authenticated;
-- ============================================
...
$$ language plpgsql security definer;
-- ============================================
-- RENEWALS: DUE-FOR-RENEWAL LOOKUP
-- ============================================
